    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-black text-zinc-900 dark:text-zinc-100 flex flex-col">
      ...
      <header className="sticky top-0 z-30 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-md border-b border-zinc-200 dark:border-zinc-800">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Link
              href="/"
              className="p-2 rounded-xl bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 text-sm font-semibold transition"
            >
              ← Kiểm kho
            </Link>
            <div>
              <h1 className="text-base font-bold text-zinc-900 dark:text-zinc-100">Bảng điều khiển Quản trị</h1>
              <span className="text-xs text-emerald-600 dark:text-emerald-400 font-medium">TONKHO Firebase</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3.5 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-semibold shadow-xs flex items-center gap-1.5 transition"
            >
              📥 Xuất Excel (.xlsx)
            </button>
          </div>
      ...
      <main className="flex-1 max-w-6xl w-full mx-auto px-4 py-6 space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="p-4 bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800">
            <span className="text-xs font-semibold text-zinc-500">Mặt hàng</span>
            <div className="text-2xl font-extrabold mt-1">{summaries.length}</div>
          </div>
          <div className="p-4 bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800">
            <span className="text-xs font-semibold text-zinc-500">Tổng số lô kiểm</span>
            <div className="text-2xl font-extrabold mt-1">{totalBatchesOverall}</div>
          </div>
          <div className="p-4 bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800">
            <span className="text-xs font-semibold text-zinc-500">Tổng tồn kho toàn bộ</span>
        ...
        <div className="flex items-center justify-between border-b border-zinc-200 dark:border-zinc-800 pb-2">
          <div className="flex gap-2">
            ...
            >
              Tổng hợp theo Sản phẩm ({summaries.length})
            </button>
            <button
              type="button"
          ...
          {activeTab === 'entries' && (
            <input
              type="text"
              placeholder="Tìm tên, mã vạch, nhân viên..."
              value={search}
              onChange={(e) => setSearch(e.target.value)}
              className="px-3 py-1.5 rounded-xl border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-xs focus:ring-2 focus:ring-emerald-500"
            />
          )}
        </div>
      ...
      {selectedEntryHistory && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-xs">
          <div className="w-full max-w-lg bg-white dark:bg-zinc-900 rounded-3xl p-6 shadow-2xl border border-zinc-200 dark:border-zinc-800 max-h-[85vh] flex flex-col">
            <div className="flex items-center justify-between pb-3 border-b border-zinc-100 dark:border-zinc-800">
              <div>
                <h3 className="text-base font-bold">Lịch sử kiểm kê lô</h3>
                <p className="text-xs text-zinc-500">{selectedEntryHistory.entry.product_name}</p>
              </div>
              <button
                type="button"
                onClick={() => setSelectedEntryHistory(null)}
                className="p-1.5 text-zinc-400 hover:text-zinc-600 rounded-full"
              >
                ✕
              </button>
            </div>
      ...
      {selectedProductDetail && (() => {
        ...
        return (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-xs">
            <div className="w-full max-w-2xl bg-white dark:bg-zinc-900 rounded-3xl p-6 shadow-2xl border border-zinc-200 dark:border-zinc-800 max-h-[85vh] flex flex-col">
              {/* Header */}
              ...
              <div className="grid grid-cols-3 gap-3 my-4">
                ...
                <div className="p-3 bg-zinc-50 dark:bg-zinc-800/50 rounded-xl border border-zinc-100 dark:border-zinc-800 text-center">
                  <span className="text-[11px] text-zinc-400">Số lượng lô</span>
